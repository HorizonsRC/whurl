...
def test_get_site_list_url():
    ...
    assert (
        url
        == """http://hilltopdev.horizons.govt.nz/boo.hts?Request=SiteList&Service=Hilltop&Location=Manawatu+at+Teachers+College&BBox=-40.50279%2C175.09327%2C-39.71855%2C175.95490%2CEPSG%3A4326&Measurement=Atmospheric+Pressure&Collection=AtmosphericPressure&SiteParameters=CatchmentName&Target=HtmlSelect&SynLevel=1"""
    )
